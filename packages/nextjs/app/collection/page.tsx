          ...
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center justify-center mb-8">
              <div className="relative">
                <div className="w-32 h-32 bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl flex items-center justify-center group hover:bg-white/15 transition-all duration-300">
                  <ShoppingBagIcon className="h-16 w-16 text-white/80 group-hover:scale-110 transition-transform duration-300" />
                  <div className="absolute -inset-0.5 bg-gradient-to-r from-white/20 to-white/10 rounded-3xl blur opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </div>
                <SparklesIcon className="absolute -top-2 -right-2 h-8 w-8 text-yellow-300 animate-pulse" />
              </div>
            </div>

            <div className="text-sm text-white/60 mb-4 font-medium tracking-wider uppercase">我的收藏</div>
